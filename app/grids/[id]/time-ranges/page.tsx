// app/grids/[id]/time-ranges/page.tsx
import { backendFetchJSON } from "@/lib/backend";
import type { Role } from "@/lib/types";
import { getCurrentUser } from "@/lib/auth";
import TimeRangesEditor from "@/components/TimeRangesEditor";

export default async function TimeRangesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <TimeRangesEditor gridId={Number(id)} canEdit={role === "supervisor"} />
      </div>
    </div>
  );
}
