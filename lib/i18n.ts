...
const ES_AR: Dictionary = {
  ...
  "grid_new.from": "Desde",
  "grid_new.to": "Hasta",
  "grid_new.cell_size_min": "Tamano de celda (min)",
  "grid_new.end_time_after_start_error": "El horario de fin debe ser posterior al inicio.",
  "grid_new.cell_size_validation_error": "El tamano de celda debe ser compatible con la configuracion.",
  "grid_new.invalid_slot_size": "Tamano de celda invalido.",
  "grid_new.interval_divisible_error": "El intervalo entre inicio y fin debe ser divisible por el tamano de celda seleccionado.",
  ...
  "grid_settings.unsupported_cell_size": "Este tamano de celda no esta soportado.",
  ...
  "grid_settings.cell_size_incompatible_entities":
    "Este tamano de celda no se puede aplicar porque algunas entidades no pueden representarse con la nueva granularidad.",
  "grid_settings.availability_rules_affected":
  ...
  "edit_cell.update_bundle_set": "Actualizar grupo",
  "edit_cell.cancel_edit": "Cancelar edición",
  "edit_cell.no_bundle_sets_saved": "No hay grupos guardados aún.",
