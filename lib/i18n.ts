...
const ES_AR: Dictionary = {
  ...
  "auth.log_in": "Iniciar sesion",
  "auth.login": "Ingresar",
  "auth.login_failed": "No se pudo iniciar sesion",
  "auth.error.invalid_credentials": "No pudimos iniciar sesion. Revisa tu email y contrasena e intenta de nuevo.",
  "auth.error.account_inactive": "Esta cuenta todavia no esta activa. Verifica tu email o contacta soporte si esto parece incorrecto.",
  "auth.error.email_exists": "Ya existe una cuenta con este email. Intenta iniciar sesion o restablecer tu contrasena.",
  "auth.error.email_invalid": "Ingresa un email valido.",
  "auth.error.password_too_short": "Usa una contrasena mas larga. Debe cumplir el largo minimo requerido.",
  "auth.error.password_too_common": "Elige una contrasena mas segura. Esta es demasiado comun.",
  "auth.error.password_numeric": "Elige una contrasena mas segura. No puede contener solo numeros.",
  "auth.error.password_policy_unmet": "Tu contrasena debe cumplir todos los requisitos.",
  ...
  "auth.password_requirements": "Requisitos de contrasena",
  ...
  "auth.passwords_do_not_match": "Las contrasenas no coinciden.",
